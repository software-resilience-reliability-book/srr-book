...
While the full call stack was not necessary to diagnose the error in this case, in a full program the function may be called in many cases. The full call stack is useful to tell us the path that the program took to get to the error - from start to finish.
